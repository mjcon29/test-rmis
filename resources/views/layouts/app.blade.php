...
<head>
    ...
    <title>{{ __('Dashboard - Record Management and Monitoring System ') }}</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://fonts.googleapis.com/css?family=Oswald:wght@400;600;700|Material+Icons" />
...
<body class="{{ $class ?? '' }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#deadline_add.datepicker').datepicker({
                dateFormat: 'yy-mm-dd'
