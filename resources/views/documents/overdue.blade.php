@extends('layouts.app', ['activePage' => $activePage, 'titlePage' => __('Dashboard'),'headerTitle' =>$headerTitle])
                ...
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="card-header card-header-primary d-flex justify-content-between align-items-center">
                            <h3 class="text-light"> <span class="text-info">{{ __($headerTitle['label']) }} :</span> {{ __($headerTitle['title']) }}</h3>
