<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog small" role="document">
        <div class="modal-content card shadow">
            ...
            <form method="post" autocomplete="off" class="form-horizontal" id="editUserForm">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }} bmd-form-group">
                                ...
                                <select name="role_id" id="role_id" class="form-control selectpicker" data-live-search="true" multiple title="No one selected">
                ...
                <div class="modal-footer">
                    <button type="submit" id="updateUser" class="btn btn-success float-left">Update</button>
