                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                  <input data-db="employee" type="text" id="employee_id" name="name" class="form-control autocomp" placeholder="{{ $document->user->name }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                  <input data-db="OriginOffice" type="text" id="origin_id" name="name" class="form-control autocomp" placeholder="{{ $document->originOffice->name }}" >
